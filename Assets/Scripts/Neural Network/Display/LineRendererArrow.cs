...
// Source: https://answers.unity.com/questions/1100566/making-a-arrow-instead-of-linerenderer.html
...
public class LineRendererArrow : MonoBehaviour
{
    ...
    public void UpdateArrow()
    {
        ...
        if (cachedLineRenderer == null) cachedLineRenderer = this.GetComponent<LineRenderer>();
